    ...
    <div class="container-fluid">
         <div class="container my-3">
             @include('frontend.user.header',['title'=>'Update Test Case'])
              <div class="row">
                <div class="col-3">
                        ...
                        <form action="{{route('testcases.store')}}" method="post" enctype="multipart/form-data" class="my-4">
                                ...
                                <select class="form-select form-select-sm" name="testsuite_id" id="testsuite_id">
                                    @if($testsuites)
                                        @foreach($testsuites as $suite)
                                            <option value="{{$suite->id}}" {{$suite->id==$testcase->testsuite_id?'selected':''}}>{{$suite->testsuite_name}}</option>
                                        @endforeach
                                    @endif
                                </select>
                            ...
                            <div class="mt-4 row">
                                ...
                                <div class="form-check form-switch ms-2">
                                    <input class="form-check-input" name="switch_steps_raw" type="checkbox" value="switch_steps_raw" id="switch_steps_raw" {{$testcase->testcase_steps=="switch_steps_raw"?'checked':''}} checked>
                            ...
                            <div class="mt-5 row">
                                ...
                                <div class="col-2">
                                <input type="button" name="btnCancel" id="btnCancel" value="Cancel" class="btn btn-primary" required>
                                </div>
