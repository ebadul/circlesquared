         ...
         <div class="container my-3">
            <div class="row">
              <div class="col-2">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-card-heading mx-4" viewBox="0 0 16 16">
              ...
              <div class="col text-center">
                ...
                <div class="div-navbar">
                    <nav class="navbar navbar-expand-lg bg-light text-end">
                        <div class="container-fluid">
